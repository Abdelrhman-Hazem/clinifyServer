...
public class Doctor  implements java.io.Serializable {
    ...
    public Doctor(DoctorTitle doctorTitle, Clinic clinic, DoctorSpecialization doctorSpecialization, String fullName, String phoneNumber, int ticketPrice, Double averageRating, Integer ratingCount, String status, Boolean isDeleted, Set appointments) {
       this.doctorTitle = doctorTitle;
       this.clinic = clinic;
       this.doctorSpecialization = doctorSpecialization;
       this.fullName = fullName;
