...
@Mapper(unmappedTargetPolicy = ReportingPolicy.IGNORE, componentModel = MappingConstants.ComponentModel.SPRING, uses = {AreaSimpleMapper.class, CitySimpleMapper.class, DoctorMapper.class})
